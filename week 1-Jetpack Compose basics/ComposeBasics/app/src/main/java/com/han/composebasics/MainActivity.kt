...
import com.han.composebasics.ui.theme.ComposeBasicsTheme
...
@Composable
private fun Greetings(names: List<String> = List(1000) { "$it" }) { // i == list index
