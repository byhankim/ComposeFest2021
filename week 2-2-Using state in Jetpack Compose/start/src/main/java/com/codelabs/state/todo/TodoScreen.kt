...
fun PreviewTodoScreen() {
    val items = listOf(
        TodoItem("Learn Jetpack compose", TodoIcon.Event),
        TodoItem("Follow the codelabs"),
        TodoItem("Apply state", TodoIcon.Done),
        TodoItem("Build dynamic UI s", TodoIcon.Square)
    )
...
// =========================================================================
//    todoitemInlineEditor, todoItemEntryInput, TodoitemInput
// =========================================================================
@Composable
